...
function toCollateral(c: CollateralRow): CollateralDto {
  return {
    ...
    realtyKind: (c.realtyKind as 'HOUSE' | 'APARTMENT' | null) ?? null,
    address: c.address,
