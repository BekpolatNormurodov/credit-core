...
const KVARTIRA = mockCaseDoc({
  ...
  collaterals: [{
    ...
    propertyType: "KO'P QAVATLI UYDAGI XONADON" as unknown as never,
    agreedValue: 266_000_000 as unknown as never,
    address: 'TOSHKENT SHAHAR YUNUSOBOD TUMANI ADOLAT MFY 4-MAVZE 61-A-UY 51-XONADON' as unknown as never,
    registryNo: '№ 1726266/R-A0000000 от 25.09.2023г.' as unknown as never,
    cadastreNo: '№ 10:07:06:01:01:5091:0001:051 от 25.09.2023г.' as unknown as never,
    totalAreaM2: 79.76 as unknown as never,
    livingAreaM2: 52.89 as unknown as never,
    usableAreaM2: 78.42 as unknown as never,
    landAreaM2: 198 as unknown as never,
    roomCount: 3 as unknown as never,
...
const HOVLI = mockCaseDoc({
  ...
  collaterals: [{
    ...
    address: "TOSHKENT VILOYATI BO'STONLIQ TUMANI QO'SHQO'RG'ON MFY QO'SHQO'RG'ON KO'CHASI 104-UY" as unknown as never,
    registryNo: '№1727224/Y-26006263 от 18.05.2026г.' as unknown as never,
    ...
    usableAreaM2: 132.8 as unknown as never,
