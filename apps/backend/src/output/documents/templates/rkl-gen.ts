...
export function rklGenTemplate(c: CaseDocData): TDocumentDefinitions {
  ...
  return {
    ...
    content: [
      ...
      p(`1.1. ММТ мижозга ${amt} сўм миқдорида ${termText} муддатга, яъни ${startStr} дан ${endStr} гача бўлган муддатга лимит билан микромолиялаш линиясини (бундан кейин ММЛ) очади ва ушбу келишув шартларига асосан мижозга Микроқарз/микрокредитлар бериш мажбуриятини олади.`),
      ...
      p(`2.3. Микроқарз/микрокредитларнинг якуний муддати ${termText === '—' ? '—' : `${termText}дан`} ошмаслиги керак. Шу билан бирга шартнома тузиш ойнаси: 6 ойгача – 54 ой; 12 ойгача – 48 ой; 18 ойгача – 42 ой; 24 ойгача – 36 ой; 30 ойгача – 30 ой; 33 ойгача – 27 ой; 48 ойгача – 12 ой ичида.`),
      p(`2.4. Фоиз ставкаси: асосий қарз бўйича йиллик ${rateText} ва муддати ўтган асосий қарз суммаси бўйича йиллик ${penaltyText}. Фоизлар ҳар куни асосий қарзнинг жорий қолдиғига нисбатан йилига 365(366) кун миқдорида ҳисобланади.`),
      ...
      ...(line?.insurance?.insured ? [
        p(`3.1.2. Тўланмаслик хавфи учун${ins?.company ? ` «${ins.company}»` : ' ММТ ни қаноатлантирадиган'} суғурта компанияси полиси илова қилинади. Суғурта суммаси${ins?.insuredSum != null ? ` ${amountWords(Number(ins.insuredSum))} сўм миқдорида` : ' мижоз олган микроқарз/микрокредит миқдоридан келиб чиқиб'} белгиланади.`),
        p(`ММТ полис учун суғурта мукофотини${ins?.premium != null ? ` ${amountWords(Number(ins.premium))} сўм миқдорида` : ins?.insuranceRate != null ? ` суғурта суммасининг йилига ${Math.round(Number(ins.insuranceRate) * 100)}% миқдорида` : ' — миқдорида'} тўлайди ва кейинчалик мижоз томонидан ушбу харажатлар қопланади.`),
      ] : []),
